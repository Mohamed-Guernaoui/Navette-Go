...
<section class=" h-cover flex w-full items-center justify-center flex-col">
    ...
    >
        ...
        <button onClick={HandeleSubmit} class="cursor-pointer whitespace-nowrap bg-black text-white rounded-lg py-3 px-6 text-xl capitalize hover:bg-opacity-80 w-fit flex ">
            Sign Up
        </button>
