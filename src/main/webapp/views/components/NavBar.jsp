    ...
    <div>
        ...
        <div class="relative flex gap-4">
            ...
            <button class="w-12 h-12 mt-1 rounded-full" onclick="toggleUserNav()">
                <img class="rounded-full object-cover w-full h-full"
                     src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.FiqQVZ9jc1WyZpJXcOa1MQHaE8%26pid%3DApi&f=1"
                     alt="User"/>
            </button>
        </div>
        <% } else { %>
        <div class="rounded-full flex flex-row justify-center items-center gap-3">
            <a style="font-family:  'Outfit', 'sans-serif'"
               class="whitespace-nowrap bg-black text-white rounded-lg py-3 px-6 text-xl capitalize hover:bg-opacity-80">
                Sign in
            </a>
            <a style="font-family:  'Outfit', 'sans-serif'" href="../../views/login.jsp"
               class="whitespace-nowrap rounded-lg py-3 px-6 text-xl capitalize hover:bg-opacity-80 bg-gray-200">
                Login
            </a>
